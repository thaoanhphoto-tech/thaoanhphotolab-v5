...
// components/studio-management/reports/ReportsPage.tsx
...
const ReportsPage: React.FC<ReportsPageProps> = ({ contracts, customers, expenses, products, materials, productBOMs, users }) => {
