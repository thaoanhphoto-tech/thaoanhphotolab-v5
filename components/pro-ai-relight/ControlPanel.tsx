...
export const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <Section title={t.preserveExpression.title}>
        <label className="flex items-center justify-between cursor-pointer">
            <span className="text-sm text-slate-600 dark:text-slate-400">Yêu cầu AI không thay đổi biểu cảm gốc.</span>
             <div className="relative">
                <input type="checkbox" className="sr-only peer" checked={settings.preserveExpression} onChange={(e) => updateSetting('preserveExpression', e.target.checked)} />
