...
export const locales: { [key: string]: Translation } = {
  vi: {
    ...
    imageDisplay: {
      ...
      sendToLabButton: 'Gửi In Lab',
      useAsOriginalButton: 'Dùng làm gốc',
    },
    postProcessing: {
      title: 'Hậu kỳ',
  ...
  en: {
    controls: {
      ...
      preserveExpression: {
        title: 'Preserve Facial Expression',
      },
    ...
    imageDisplay: {
      ...
      sendToLabButton: 'Send to Lab',
      useAsOriginalButton: 'Use as Original',
    },
    postProcessing: {
    ...
    error: {
      ...
      generationFailed: 'Image generation failed. Your request might have been rejected by the AI.',
