...
export const ConceptSelector: React.FC<ConceptSelectorProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      {selectedConcept && (
        <div>
            {selectedConcept.previewUrl && (
                <div className="mb-4">
                     <h4 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">Ảnh mẫu concept</h4>
                     <img src={selectedConcept.previewUrl} alt={selectedConcept.name} className="w-full h-auto object-contain rounded-lg border border-slate-200 dark:border-zinc-700" />
                </div>
            )}
